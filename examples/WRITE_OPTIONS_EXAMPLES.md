...
This directory contains example JSON configurations demonstrating how to use the new write options system in the data metadata-driven ingestion framework.
