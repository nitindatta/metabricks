...
config = {
    ...
    "source": {
        "type": "rest",
        "endpoint": "https://api.data.org/v1/metadata",
        "auth": {
            "type": "bearer",
            "token_path": "/Volumes/main/shared/secrets/data_token.txt"
        },
        "pagination": {
            "type": "offset",
            "limit": 1000,
...
config = {
    ...
    "sink": {
        ...
        "volume_path": "/Volumes/main/shared/data_streaming",
        "format": "delta",
        "mode": "append",
...
config = {
    ...
    "source": {
        ...
        "url": "jdbc:postgresql://prod-db.internal:5432/data_source",
...
```json
{
  "name": "Daily data Metadata Ingest",
  "schedule": {
...
dbutils.widgets.text("schema", "test_data")
