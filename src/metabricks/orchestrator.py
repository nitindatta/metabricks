...
from metabricks.core.asset_identifiers import get_source_asset_identifier, get_sink_asset_identifier
...
def run_pipeline(
    ...
    *,
    ...
    # Compute asset identifiers for lineage tracking
    source: SourceConfig = cfg.source
    source_asset = get_source_asset_identifier(source)
    sink_asset = None
    if cfg.sink is not None:
        sink_asset = get_sink_asset_identifier(cfg.sink)
    ...
    publish_event(
        ...
        details={"system_type": source.system_type, "mode": source.extraction_mode}
    )
    ...
    publish_event(
        ...
        source_system=cfg.source_system,
        source_dataset_id=cfg.source_dataset_id,
        details={"payload_type": env.payload_type}
    )
    ...
    if cfg.sink is not None:
        ...
        publish_event(
            ...
            source_system=cfg.source_system,
            source_dataset_id=cfg.source_dataset_id,
            details={"system_type": sink_cfg.system_type, "mode": mode}
        )
        ...
        publish_event(
            ...
            source_system=cfg.source_system,
            source_dataset_id=cfg.source_dataset_id,
            details={"sink": sink.__class__.__name__}
        )
